...
const testimonialData: Testimonial[] = [
  ...
  },
  {
    id: 3,
    name: " مریم کوهستانی",
    designation: "نیویورک آمریکا",
    content:
      "همیشه حواله های ماهانه خود را با تیم حواله خانه اجرا میکنم و تا هنوز بهترین تجربه را داشتم.",
...
const Testimonials = () => {
  return (
    <section className="dark:bg-bg-color-dark bg-gray-light relative py-4 md:py-5 lg:py-10">
      <div className="container">
        <SectionTitle
          title="نظریات مشتریان گرامی"
          paragraph="مشتریان ما با اهمیت ترین دارای ما هستند. تیم ما نهایت کوشش شان را در این راستا انجام خواهد داد."
          center
        />
